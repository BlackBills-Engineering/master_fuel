# app/pumpmaster.py  — версия «выводим СЫРЫЕ кадры»
...
class PumpMaster:
    GAP, TIMEOUT = .25, 1.0    # 250 мс между колонками
    ...
    async def _handle_dc(self, addr:int, dc:int, pl:bytes):
        ...
        # DC-1 STATUS — сохраняем и шлём в WebSocket
        if dc==0x01 and pl:
            code = pl[0]
        ...
        # DC-2 — литры/сумма (если колонка вдруг пришлёт)
        ...
        # все остальные пока игнорим – главное, что пишем RAW-строку
